...
public class MergedGoConfigTest {
    ...
    public void setUp() throws Exception {
        ...
        mergedGoConfig = new MergedGoConfig(serverHealthService,cachedFileGoConfig, dataSource);
    ...
    //TODO: jyoti - i think this should be deleted
    @Test
    public void shouldListenForPartialChangesUponCreation()
    {
        assertTrue(partials.hasListener((MergedGoConfig) mergedGoConfig));
    }
    //TODO: jyoti - i think this should be deleted
    @Test
    public void shouldListenForFileChangesUponCreation()
    {
        assertTrue(mergedGoConfig.hasListener((MergedGoConfig) mergedGoConfig));
    }
    ...
    public void shouldDelegateWritePipelineConfigCallToFileService(){
        ...
        when(fileService.writePipelineWithLockNew(pipelineConfig, holderBeforeUpdate, saveCommand, user)).thenReturn(saveResult);
        ...
        verify(fileService).writePipelineWithLockNew(pipelineConfig, holderBeforeUpdate, saveCommand, user);
    }
    ...
    public void shouldReturnDefaultCruiseConfigIfLoadingTheConfigFailsForTheFirstTime() throws Exception {
        configHelper.writeXmlToConfigFile("invalid-xml");
        mergedGoConfig = new MergedGoConfig(new ServerHealthService(), new CachedFileGoConfig(dataSource, new ServerHealthService()), dataSource);
    ...
    @Test public void shouldNotNotifyWhenConfigIsNullDuringRegistration() throws Exception {
        ...
        mergedGoConfig = new MergedGoConfig(serverHealthService, new CachedFileGoConfig(dataSource, serverHealthService), dataSource);
        final ConfigChangedListener listener = mock(ConfigChangedListener.class);
        mergedGoConfig.registerListener(listener);
    ...
    public void shouldReturnMergedStatusWhenConfigIsMergedWithStaleCopy(){
        ...
        mergedGoConfig = new MergedGoConfig(serverHealthService, new CachedFileGoConfig(dataSource, serverHealthService), goFileConfigDataSource);

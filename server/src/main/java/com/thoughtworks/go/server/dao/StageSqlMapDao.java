...
public class StageSqlMapDao extends SqlMapClientDaoSupport implements StageDao, StageStatusListener, JobStatusListener {
    ...
    private String cacheKeyForStageCount(String pipelineName, String stageName) {
        return String.format("%s_numberOfStages_%s_<>_%s", getClass().getName(), pipelineName.toLowerCase(), stageName.toLowerCase()).intern();
    }
    ...
    private String cacheKeyForListOfStageIdentifiers(StageIdentifier stageIdentifier) {
        return String.format("%s_stageRunIdentifier_%s_%s_%s", getClass().getName(), stageIdentifier.getPipelineName().toLowerCase(), stageIdentifier.getPipelineCounter(),
                stageIdentifier.getStageName().toLowerCase()).intern();
    }

    private String cacheKeyForStageIdentifier(StageIdentifier stageIdentifier) {
        return String.format("%s_stageIdentifier_%s_%s_%s_%s", getClass().getName(), stageIdentifier.getPipelineName().toLowerCase(), stageIdentifier.getPipelineCounter(),
                stageIdentifier.getStageName().toLowerCase(), stageIdentifier.getStageCounter()).intern();
    }
    ...
    private String cacheKeyForAllStageOfPipeline(String pipelineName, Integer pipelineCounter, String stageName) {
        return String.format(getClass().getName() + "_allStageOfPipeline_%s_%s_%s", pipelineName.toLowerCase(), pipelineCounter, stageName.toLowerCase()).intern();
    }
    ...
    private String mutexForStageHistory(String pipelineName, String stageName) {
        return String.format("%s_stageHistoryMutex_%s_<>_%s", getClass().getName(), pipelineName.toLowerCase(), stageName.toLowerCase()).intern();
    }

    private String cacheKeyForStageHistories(String pipelineName, String stageName) {
        return String.format("%s_stageHistories_%s_<>_%s", getClass().getName(), pipelineName.toLowerCase(), stageName.toLowerCase()).intern();
    }

    private String cacheKeyForDetailedStageHistories(String pipelineName, String stageName) {
        return String.format("%s_detailedStageHistories_%s_<>_%s", getClass().getName(), pipelineName.toLowerCase(), stageName.toLowerCase()).intern();
    }
    ...
    private String cacheKeyForStageOffset(Stage stage) {
        return String.format("%s_stageOffsetMap_%s_<>_%s", getClass().getName(), stage.getIdentifier().getPipelineName().toLowerCase(), stage.getIdentifier().getStageName().toLowerCase()).intern();
    }
    ...
    private String cacheKeyForStageCountForGraph(String pipelineName, String stageName) {
        return String.format("%s_totalStageCountForChart_%s_%s", getClass().getName(), pipelineName.toLowerCase(), stageName.toLowerCase()).intern();
    }
    ...
    String cacheKeyForMostRecentId(String pipelineName, String stageName) {
        return String.format("%s_mostRecentId_%s_%s", getClass().getName(), pipelineName.toLowerCase(), stageName.toLowerCase()).intern();
    }
